...
- `.codex-plugin/` contains the ChatGPT/Codex manifest.
- `.agents/plugins/marketplace.json` exposes the repository root as the OpenAI marketplace package.
- `skills/`, `.mcp.json`, and `hooks/hooks.json` are shared across hosts.

...
If there is a new conversation worth turning into a Saywise story, draft it; if nothing clears the bar, draft nothing. Either way, update the state file and report what happened. Nothing is uploaded — the user posts drafts themselves.
